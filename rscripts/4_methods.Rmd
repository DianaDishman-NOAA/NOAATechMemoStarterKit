...
Here is the report methodology! Here is some equation you'll need to have in this report, of which produces the variable $X$. 
...
plot.list<-SaveGraphs(plot = plot, plot.list = plot.list, 
           filename0 = filename0, 
